...
public class TSmmParser extends Parser {
	...
	public static final int
		...
		RULE_expression = 8, RULE_expression_list = 9;
	...
	public final Function_typeContext function_type() throws RecognitionException {
		...
		try {
			...
			match(T__4);
			setState(130);
			((Function_typeContext)_localctx).st1 = simple_type();
			_localctx.params.add(new VarDefinition((((Function_typeContext)_localctx).ID1!=null?((Function_typeContext)_localctx).ID1.getText():null), ((Function_typeContext)_localctx).st1.ast, ((Function_typeContext)_localctx).ID1.getLine(), ((Function_typeContext)_localctx).ID1.getCharPositionInLine()+1)); 
			setState(140);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==T__9) {
				...
				match(T__4);
				setState(135);
				((Function_typeContext)_localctx).st2 = simple_type();
				_localctx.params.add(new VarDefinition((((Function_typeContext)_localctx).ID2!=null?((Function_typeContext)_localctx).ID2.getText():null), ((Function_typeContext)_localctx).st2.ast, ((Function_typeContext)_localctx).ID2.getLine(), ((Function_typeContext)_localctx).ID2.getCharPositionInLine()+1));
				}
				}
				setState(142);
				_errHandler.sync(this);
			...
			((Function_typeContext)_localctx).ast =  new FunctionType(((Function_typeContext)_localctx).type.ast, _localctx.params); 
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static final String _serializedATN =
		...
		"\u00df\b\u0007\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b"+
		"\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001"+
		"\b\u0001\b\u0003\b\u00f2\b\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001"+
		"\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001"+
		"\b\u0001\b\u0001\b\u0003\b\u0105\b\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001"+
		"\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001"+
		"\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001"+
		"\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0005\b\u0125"+
		"\b\b\n\b\f\b\u0128\t\b\u0001\t\u0001\t\u0001\t\u0001\t\u0001\t\u0001\t"+
